...
/** Known ERC4626 market IDs used by WalletGenie Treasury vaults */
const KNOWN_ERC4626_MARKET_IDS = [100_001n, 100_002n, 100_003n, 100_004n];

/**
 * Read a PlasmaVault's unallocated ERC20 tokens and ERC4626 (wgenie) positions.
 *
 ...
 *
 * For wgenie positions: reads known ERC4626 market substrates (100001-100004) directly,
